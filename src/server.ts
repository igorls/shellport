...
/**
 * Maximum payload size for WebSocket messages (1MB).
 * Enforced natively by Bun to prevent memory exhaustion DoS attacks.
 */
...
export async function startServer(config: ServerConfig): Promise<void> {
    ...
    Bun.serve({
        ...
        websocket: {
            // Prevent large payload memory allocation DoS attacks
