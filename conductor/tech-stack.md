...
- **Sanitization:** Server-side PTY data sanitization (filtering DSR and OSC 52) and strict WebSocket frame size limits (1MB).
...
- **Handshake:** Per-session salt derived from mutual nonces to prevent precomputation attacks.
